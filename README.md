...
The Arduino Mega controls two DC motors through the L298N motor driver, enabling precise control of direction and speed. The robot follows a predefined movement path while continuously monitoring its surroundings using infrared sensors. When an obstacle or wall is detected, the control program modifies motor direction and timing to avoid collisions and maintain smooth navigation.
...
-Circuit Diagram
![Image](https://github.com/user-attachments/assets/b26a9606-75f3-434a-a9f5-10a0416f61bd)
